...
public class SaleEntity {
    ...
    // FK to CustomerEntity — optional (populated when sale originates from a bill)
    @ManyToOne
    ...
    // Selling rate snapshot at the moment of sale — never changes after creation
    ...
    // Denormalised customer name for display (kept for backwards compat + quick reads)
    ...
    /** Reason provided when the sale is cancelled or admin-deleted (MEDIUM-5) */
