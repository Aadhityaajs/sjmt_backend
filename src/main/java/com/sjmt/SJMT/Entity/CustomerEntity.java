...
public class CustomerEntity {
    ...
    @Column(name = "pincode", nullable = false, updatable = true, length = 10)
    ...
    public CustomerEntity(String customerName, String customerEmail, String phoneNumber, String gstNumber, String address, String city, String state, String pincode, LocalDateTime createdAt, CustomerStatusEnum status) {
        this.customerName = customerName;
        this.customerEmail = customerEmail;
        this.phoneNumber = phoneNumber;
        this.gstNumber = gstNumber;
