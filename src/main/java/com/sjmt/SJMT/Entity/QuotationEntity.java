...
public class QuotationEntity {
    ...
    // true after stock has been soft-reserved on ACCEPTED transition.
    // Cleared back to false when the quotation is EXPIRED or CONVERTED.
    ...
    /** Username of the last user who modified this quotation (MEDIUM-6) */
