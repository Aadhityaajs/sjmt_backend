...
public class AuthenticationController {
    ...
    /**
     * Verify email endpoint - redirects to frontend verify email page
     */
    @GetMapping("/verify-email")
    @Operation(summary = "Verify email", description = "Redirects to frontend email verification page")
    public ResponseEntity<Void> verifyEmail(@RequestParam String token) {
        logger.info("Email verification request received, redirecting to frontend");
        String redirectUrl = frontendUrl + "/verify-email?token=" + token;
