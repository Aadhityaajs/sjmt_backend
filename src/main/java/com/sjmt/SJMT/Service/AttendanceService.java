...
public interface AttendanceService {
     ...
     * @param adminUserId ID of admin marking attendance
     * @return AttendanceResponse
     */
    AttendanceResponse markAttendance(MarkAttendanceRequest request, Integer adminUserId);

    /**
     * Update existing attendance record
     * @param request Update attendance request
     * @param adminUserId ID of admin updating attendance
     * @return AttendanceResponse
     */
    AttendanceResponse updateAttendance(UpdateAttendanceRequest request, Integer adminUserId);
