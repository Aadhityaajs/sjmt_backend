...
public interface CustomerBillRepository extends JpaRepository<CustomerBillEntity, Integer> {
    ...
    // MEDIUM-12: All DRAFT bills for a customer (for auto-cleanup on blacklist/delete)
    java.util.List<CustomerBillEntity> findByCustomer_CustomerIdAndStatus(
            Integer customerId, BillStatus status);
}