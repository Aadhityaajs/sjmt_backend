...
public class CustomerBillResponse {
    ...
    private Integer quotationId;       // null if not converted from a quotation
    ...
    public List<CustomerBillItemResponse> getItems() { return items; }
    public void setItems(List<CustomerBillItemResponse> items) { this.items = items; }
